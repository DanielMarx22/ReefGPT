...
import { LayoutDashboard, Fish, ActivitySquare } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="h-14 bg-slate-900 border-b border-slate-800 flex items-center px-6 gap-8 shrink-0">
